...
class PaymentSettingController extends Controller
{
    ...
    private function validateEnabledPaymentMethods(Request $request, array $validatedData): void
    {
        ...
        if ($request->boolean('is_manually_enabled')) {
            // Manual payment doesn't require validation of credentials
            // Just ensure it's properly enabled
        }
    ...
    private function filterSensitiveData(array $settings): array
    {
        ...
        $enabledKeys = [
            ...
            'is_toyyibpay_enabled', 'is_benefit_enabled',
        ...
        $frontendKeys = [
            ...
            'fedapay_public_key', 'nepalste_public_key',
