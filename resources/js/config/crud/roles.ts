...
export const rolesConfig: CrudConfig = {
  ...
  form: {
    fields: [
      { name: 'label', label: t('Role Name'), type: 'text', placeholder: t('Enter role name'), required: true },
      { name: 'description', label: t('Description'), type: 'textarea', placeholder: t('Enter role description') }
