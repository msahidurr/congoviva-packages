      ...
      <div className="border rounded shadow-sm p-3 bg-gray-50">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="select-all-permissions-checkbox" className="cursor-pointer font-medium">
          ...
          <div key={module} className="border rounded shadow-sm">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 border-b">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor={`module-checkbox-${module.replace(/\s+/g, '-').toLowerCase()}`} className="cursor-pointer font-medium">
                  {module}
                </Label>
              </div>
              <div className="text-xs text-gray-500">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                {modulePermissions.map((permission) => (
                  <div key={permission.id} className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor={`permission-checkbox-${permission.id.toString().replace(/\s+/g, '-').toLowerCase()}`} className="cursor-pointer text-sm truncate">
                      {permission.label}
                    </Label>
                  </div>
                ))}
