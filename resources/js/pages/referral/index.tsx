...
export default function Referral() {
  ...
  const { props } = usePage();
  const { userType, settings, stats, payoutRequests, referralLink, referredUsers, currencySymbol, globalSettings } = props as any;
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row gap-8">
        <div className="md:w-64 md:self-start flex-shrink-0">
