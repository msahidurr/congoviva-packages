...
import { Save, HardDrive, Search, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              className="pr-10"
            />
            <button type="button" onClick={() => setShowAwsSecret(p => !p)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground cursor-pointer">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input
              ...
              className="pr-10"
            />
            <button type="button" onClick={() => setShowWasabiSecret(p => !p)} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground cursor-pointer">
              {showWasabiSecret ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
            </button>
          </div>
        </div>
