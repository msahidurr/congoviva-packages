        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) => updateSectionData('about', { layout: value })}
            >
              <SelectTrigger id="about_layout">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="image-right">{t("Content Left, Image Right")}</SelectItem>
                <SelectItem value="image-left">{t("Image Left, Content Right")}</SelectItem>
                <SelectItem value="centered">{t("Centered Content")}</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="space-y-3">
            ...
            <Select
              ...
              onValueChange={(value) => updateSectionData('about', { image_position: value })}
            >
              <SelectTrigger id="about_image_position">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            <MediaPicker
              label={t("About Image")}
              value={getImageDisplayUrl(getSectionData('about').image || '')}
              onChange={(value) => {
                updateSectionData('about', { image: convertUrlToRelativePath(value) });
              }}
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    >
                      <SelectTrigger id={`about_stat_${index}_color`}>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
            ...
            <div key={index} className="bg-gray-50 border border-gray-200 rounded-xl p-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <SelectTrigger id={`about_value_${index}_icon`}>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
