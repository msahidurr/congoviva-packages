...
const availableTemplates = [
  ...
  { name: 'neutral-professional', category: 'services' },
  { name: 'hotel-resort', category: 'business' },
  { name: 'influencer', category: 'professional' },
  { name: 'actor', category: 'professional' },
  { name: 'car-mechanic', category: 'services' },
  { name: 'sports-academy', category: 'sports' },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <Select
                ...
                onValueChange={(value) => updateSectionData('templates', { layout: value })}
              >
                <SelectTrigger id="templates_layout">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-3">
              ...
              <Select
                value={String(getSectionData('templates').columns || 3)}
                onValueChange={(value) => updateSectionData('templates', { columns: parseInt(value) })}
              >
                <SelectTrigger id="templates_columns">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
