...
export default function MenuMarketplaceSettings() {
  ...
  const saveSettings = () => {
    ...
    router.post(route('menu.marketplace.settings.update'), data, {
      preserveScroll: true,
      onSuccess: (page) => {
        setIsLoading(false);
  ...
  const addFeature = () => {
    setData('features', [...data.features, { title: '', description: '', icon: 'utensils' }]);
  };
  ...
  const breadcrumbs = [
    ...
    { title: t('Menu Marketplace Settings') }
  ];

  return (
    <PageTemplate 
      title={t("Menu Marketplace Settings")} 
      url="/menu-qr-code/marketplace/settings"
      breadcrumbs={breadcrumbs}
      action={
        <div className="flex gap-2">
          <Button
            onClick={() => window.open(route('menu.marketplace'), '_blank')}
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      placeholder="Digital Menu QR Code Add-on"
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={3}
                      placeholder="Create professional digital menus with QR codes"
                    />
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      <Input
                        id="primary_color"
                        type="color"
                        value={data.primary_color || '#D2691E'}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      <Input
                        id="secondary_color"
                        type="color"
                        value={data.secondary_color || '#CD853F'}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      <Input
                        id="accent_color"
                        type="color"
                        value={data.accent_color || '#F5DEB3'}
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      placeholder={t('Powerful Menu Features')}
                    />
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Textarea
                      ...
                      placeholder={t('Everything you need for professional digital menu management')}
                      rows={3}
                    />
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      <Input
                        ...
                        type="color"
                        value={data.features_icon_color || '#D2691E'}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="space-y-3">
                          ...
                          <Input
                            ...
                            placeholder={t('Multiple Menu Templates')}
                          />
                        </div>
                        ...
                        <div className="space-y-3 md:col-span-1">
                          ...
                          <Textarea
                            ...
                            placeholder={t('Choose from 5 unique menu designs for different restaurant types')}
                            rows={3}
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <Input
                            ...
                            placeholder={t('Digital Menus Created')}
                          />
                          <Button
                            type="button"
                            variant="outline"
                ...
                <div className="grid grid-cols-1 gap-4 mb-6">
                  <div className="space-y-3">
                    ...
                    <Input
                      ...
                      placeholder={t('See Menu QR Code in Action')}
                    />
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <Textarea
                      ...
                      placeholder={t('Discover how easy it is to create and manage digital menus with our intuitive interface and powerful features.')}
                      rows={3}
                    />
                  </div>
                </div>
                      ...
                      <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="space-y-3">
                          ...
                          <Textarea
                            ...
                            placeholder={t('Beautiful, responsive menu pages that work on all devices')}
                            rows={2}
                          />
                        </div>
                      </div>
